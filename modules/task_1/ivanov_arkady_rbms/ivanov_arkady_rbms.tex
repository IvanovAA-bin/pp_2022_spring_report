...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./images/boost_comparsion_8thrd.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./images/sort_time_8thrd.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./images/boost_omp.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./images/boost_tbb.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./images/boost_std_without_affinity.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./images/boost_std_with_affinity.jpg}
